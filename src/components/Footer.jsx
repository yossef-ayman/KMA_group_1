        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4 text-center md:text-left">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center justify-center md:justify-start gap-1.5 text-xs text-amber-900 font-medium">
                <Heart className="w-3.5 h-3.5 text-amber-700 fill-amber-700" />
                <span>Premier Cinematography & Luxury Wedding Media Production</span>
              </div>
              <p className="text-xs text-stone-500 flex items-center justify-center md:justify-start">
                <span>© {new Date().getFullYear()} {t(data.profile?.shortName) || 'KMA'}. All rights reserved.</span>
              </p>
            </div>
          </div>
